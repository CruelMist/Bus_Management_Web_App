...
<nav class="navbar navbar-expand-lg navbar-inverse navbar-fixed-top  navbar-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	...
	<body>
		...
		<div class="container">
		<header>
                    <a href="#"><h1>Host a Trip</h1></a>
		</header>
		<section>
			<div class="row">
                                
				<div class="col-md-8">
                                    <form action="Host" post="method">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="from" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleFormControlInput1">To</label>
                                            <input type="text" name="to" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleFormControlInput1">Car License Number</label>
                                            <input type="text" name="car_plate" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com">
                                        </div>
                                        <div class="form-group">
