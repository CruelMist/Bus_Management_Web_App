...
<!--                    <tr>
                ...
                <div class="sub-col">
                <button type="button" class="btn-sch bt-edit" onclick=window.location.href='edit_user.jsp'>Edit Users</button>    
                ...
                <button type="button" class="btn-sch bt-del" id="bt-del">Delete User</button>
        ...
        <script>
            ...
            %>
            var count=0;
            $(".del<%=b.getPwd()%>").mouseover(function(){
                $(".del<%=b.getPwd()%>").css('background-color','white');
                $(".del<%=b.getPwd()%>").css('border','white');
                $(".del-svg<%=b.getPwd()%> .si-glyph-fill").css('fill','black');
            });
            $(".del<%=b.getPwd()%>").mouseout(function(){
                $(".del<%=b.getPwd()%>").css('background-color','black');
                $(".del<%=b.getPwd()%>").css('border','black');
                $(".del-svg<%=b.getPwd()%> .si-glyph-fill").css('fill','red');
            });
            <%}%>
