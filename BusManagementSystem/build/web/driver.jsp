...
<!DOCTYPE html>
<% 
    DriverDAO schAccess=new DriverDAO();
    List <Driver> list=schAccess.getDriver();
    int count=0;
    ...
    <body>
        ...
        <div class="container">
            <div class="col1">
                ...
                <table class="sch">
                    <tr class="thead">
                        <th>Driver ID</th><th>Name</th><th>Contact Number</th>
                    </tr>
                    <% 
                        for(Driver sch:list){
                            count+=1;
...
<!--                    <tr>
                ...
                <button type="button" class="btn-sch bt-edit" onclick=window.location.href='edit_driver.jsp'>Edit Drivers</button>
                    <%}
                        }
                    }
                %>
                ...
                <%
                    for(User u:uL)
                    {
                        ...
                        {
                            if(u.getType().equals("admin")){%>
                <button type="button" class="btn-sch bt-del" id="bt-del">Delete Driver</button>
                <%}
                        }
                    }
                %>
        ...
        <script>
            ...
            %>
            var count=0;
            $(".del<%=b.getDriverID()%>").mouseover(function(){
                $(".del<%=b.getDriverID()%>").css('background-color','white');
                $(".del<%=b.getDriverID()%>").css('border','white');
                $(".del-svg<%=b.getDriverID()%> .si-glyph-fill").css('fill','black');
            });
            $(".del<%=b.getDriverID()%>").mouseout(function(){
                $(".del<%=b.getDriverID()%>").css('background-color','black');
                $(".del<%=b.getDriverID()%>").css('border','black');
                $(".del-svg<%=b.getDriverID()%> .si-glyph-fill").css('fill','red');
            });
            <%}%>
