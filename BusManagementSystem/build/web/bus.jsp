    ...
    <body>
        ...
        <div class="container">
            <div class="col1">
                ...
                <table class="sch">
                    <tr class="thead">
                        <th>Bus ID</th><th>Bus License</th>
                    </tr>
                    <% 
                        for(Bus sch:list){
                            count+=1;
...
<!--                    <tr>
                ...
                <button type="button" class="btn-sch bt-edit" onclick=window.location.href='edit_bus.jsp'>Edit Buses</button>
                    <%}
                        }
                    }
                %>
                ...
                <%
                    for(User u:uL)
                    {
                        ...
                        {
                            if(u.getType().equals("admin")){%>
                <button type="button" class="btn-sch bt-del" id="bt-del">Delete Bus</button>
                            <%}
                        }
                    }
                %>
        ...
        <script>
            ...
            %>
            var count=0;
            $(".del<%=b.getBusLisance()%>").mouseover(function(){
                $(".del<%=b.getBusLisance()%>").css('background-color','white');
                $(".del<%=b.getBusLisance()%>").css('border','white');
                $(".del-svg<%=b.getBusLisance()%> .si-glyph-fill").css('fill','black');
            });
            $(".del<%=b.getBusLisance()%>").mouseout(function(){
                $(".del<%=b.getBusLisance()%>").css('background-color','black');
                $(".del<%=b.getBusLisance()%>").css('border','black');
                $(".del-svg<%=b.getBusLisance()%> .si-glyph-fill").css('fill','red');
            });
            <%}%>
