...
<html lang="en" dir="ltr">
    ...
    <body>
        ...
        <div class="container">
            <div class="form-box">
                <button type="button" class="control"><a href="user.jsp">Back</a></button>
                <form name="edit_schedule" action="AddUser" method="POST">
                    <p class="type">Enter Email:</p>
                    <input id="mail" name="mail" type="text" placeholder="Email" required>
                    <p class="type">Enter Password:</p>
                    ...
                    <button type="submit"><a href="user.jsp">Submit</a></button>
                </form>
            </div>
        </div>
        <div class="footer">
