<%-- 
    Document   : edit_route
    Created on : Mar 31, 2019, 4:59:47 PM
    Author     : My Pc
--%>
...
<html lang="en" dir="ltr">
    ...
    <body>
        ...
        <div class="container">
            <div class="form-box">
                <button type="button" class="control"><a href="route.jsp">Back</a></button>
                <form name="edit_schedule" action="AddRoute" method="POST">
                    <p>New Route:</p>
                    <input type="text" name="route">
                    
                    
                    
                    <button type="submit"><a href="route.jsp" required>Submit</a></button>
