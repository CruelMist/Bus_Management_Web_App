...
<html lang="en" dir="ltr">
    ...
    <body>
        ...
        <div class="container">
            <div class="form-box">
                <button type="button" class="control"><a href="bus.jsp">Back</a></button>
                <form name="edit_bus" action="AddBus" method="POST">
                    <p>Bus License:</p>
                    <input type="text" name="busLicense" required>
                    
                   
                    <button type="submit"><a href="bus.jsp">Submit</a></button>
