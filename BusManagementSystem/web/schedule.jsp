    ...
    <body>
        ...
        <div class="container">
            <div class="col1">
                ...
                <table class="sch">
                    <tr class="thead">
                        <th>Bus ID</th><th>Driver Name</th><th>Contact</th><th>Route</th><th>Date</th>
                    </tr>
                    <% 
...
<!--                    <tr>
                ...
                <div class="sub-col">
                    <%for(User u:uL)
                    {
                        ...
                        {
                            if(u.getType().equals("admin")||u.getType().equals("staff")){%>
                <button type="button" class="btn-sch bt-edit" onclick=window.location.href='edit_schedule.jsp'>Edit Schedule</button>
                <%}
                        }
                    }
                %>
                ...
                <%for(User u:uL)
                    {
                        ...
                        {
                            if(u.getType().equals("admin")||u.getType().equals("staff")){%>
                <button type="button" class="btn-sch bt-del" id="bt-del">Delete Schedule</button>
                <%}
                        }
                    }
                %>
